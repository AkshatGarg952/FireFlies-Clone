...
export const meetings: MeetingPreview[] = [
  {
    ...
    transcript: [
      { id: "l1", speaker: "Aditi", timestamp: "00:08", text: "Let's review where we are on launch readiness." },
      { id: "l2", speaker: "Rahul", timestamp: "00:21", text: "Engineering is done, but we still need the final checklist." },
      { id: "l3", speaker: "Meera", timestamp: "00:34", text: "I will update the copy and share the final version today." },
      { id: "l4", speaker: "Aditi", timestamp: "00:49", text: "Good, let's lock the launch owner before end of day." }
    ]
  },
  {
    id: "m2",
    ...
    transcript: [
      { id: "l1", speaker: "Aman", timestamp: "00:10", text: "We need to close the onboarding feedback loop." },
      { id: "l2", speaker: "Nisha", timestamp: "00:24", text: "The new layout is ready for review." }
    ]
  }
];
